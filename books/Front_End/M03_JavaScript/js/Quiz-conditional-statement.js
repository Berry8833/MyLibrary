...
let questions = [
    {
        "question": "What is the value of variable 'a' in the code?",
        "options": ["50", "100", "200", "0"],
        "answer": "100"
    },
    {
        "question": "What does the variable 'b' represent in the code?",
        "options": [
    ...
    {
        "question": "What will be logged to the console if the value of 'b' is true and 'c' is false?",
        "options": [
            "✅ ✅",
            "✅ ❌",
            "❌ ✅",
    ...
    {
        "question": "In the switch statement for the variable 'month', what message is logged if the month is 'May'?",
        "options": [
        ...
        "answer": "It's my birthday month."
    },
    {
        "question": "What is the default case in the switch statement for 'month'?",
        "options": [
            "It is not my birthday month.",
            "Happy Birthday!",
            "It's my birthday month.",
    ...
    {
        "question": "Which flower does the code indicate that the user likes?",
        "options": [
            "Lily",
            "Tulip",
            "Rose",
    ...
    {
        "question": "What will be logged to the console if the variable 'flowers' is set to 'Tulip'?",
        "options": [
            "I like rose flower.",
            "I don't like tulip flower.",
            "I don't like lily flower.",
            "I love you."
        ],
        "answer": "I don't like tulip flower."
    },
    {
        "question": "What will be the output if none of the cases match in the switch statement for 'flowers'?",
        "options": [
            "I don't like tulip flower.",
            "I like rose flower.",
            "I love you.",
    ...
    {
        "question": "What is the result of the condition '100 < 20' in the code?",
        "options": ["true", "false", "undefined", "0"],
        "answer": "false"
    },
    {
        "question": "What does the console log if both 'b' and 'c' are false?",
        "options": [
            "✅ ✅",
            "✅ ❌",
            "❌ ✅",
