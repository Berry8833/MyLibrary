...
let questions = [
    {
        "question": "What type of data structure is used to store student names?",
        "options": [
            "Object",
            "Array",
            "String",
    ...
    {
        "question": "How many students are in the 'student' array?",
        "options": [
            "3",
            "4",
            "5",
    ...
    {
        "question": "What will be logged to the console for each student in the 'student' array?",
        "options": [
            "Hello!",
            "Great to see you!",
            "Welcome!",
    ...
    {
        "question": "Which flower is mentioned in the 'flowers' array?",
        "options": [
            "Rose",
            "Daisy",
            "Orchid",
    ...
    {
        "question": "What will be logged to the console when the length of the 'flowers' array is printed?",
        "options": [
            "3",
            "4",
            "5",
    ...
    {
        "question": "What type of loop is used to iterate over the 'fruits' array?",
        "options": [
            "for loop",
            "while loop",
            "do-while loop",
    ...
    {
        "question": "How many times will the while loop run for 'a' in 'while (a < 10)'?",
        "options": [
            "9",
            "10",
            "11",
    ...
    {
        "question": "What will be logged to the console for each fruit in the 'fruits' array?",
        "options": [
            "I love fruits!",
            "My favourite fruit is!",
            "My favourite fruit is",
            "My favourite fruit is [fruit name]."
        ],
        "answer": "My favourite fruit is [fruit name]."
    },
    {
        "question": "What is the initial value of 'x' in the second while loop?",
        "options": [
            "40",
            "45",
            "50",
    ...
    {
        "question": "What will be logged to the console when the while loop with 'x' runs?",
        "options": [
            "The answer is 50",
            "The answer is 60",
            "The number is 50",
