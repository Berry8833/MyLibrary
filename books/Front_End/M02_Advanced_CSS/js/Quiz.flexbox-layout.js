...
let questions = [
    {
      "question": "What is the main heading of the website?",
      "options": [
    ...
    {
      "question": "Which layout technique is used in the main section of the page?",
      "options": [
        "Grid",
        "Flexbox",
        "Table",
    ...
    {
      "question": "What is the price of the camera listed in the store?",
      "options": [
        "$300",
        "$150",
        "$30",
    ...
    {
      "question": "What color is the header background in the card sections?",
      "options": [
        "Blue",
        "Silver",
        "Green",
    ...
    {
      "question": "Which of the following products is NOT listed in the HTML?",
      "options": [
        "Toilet-Paper",
        "Wooden-Spoons",
        "Laptop",
    ...
    {
      "question": "What is the minimum width of the images in the card sections?",
      "options": [
        "200px",
        "300px",
        "400px",
    ...
    {
      "question": "What font family is applied to the body of the page?",
      "options": [
        "Arial",
        "Courier",
        "Serif",
    ...
    {
      "question": "How much does the soap cost according to the code?",
      "options": [
        "$5",
        "$10",
        "$30",
    ...
    {
      "question": "What is the padding applied to the main header?",
      "options": [
        "10px",
        "20px",
        "40px",
    ...
    {
      "question": "How is the layout of the cards structured?",
      "options": [
        "In a single column",
        "In a grid format",
        "In a flex layout with wrapping",
        "In a table format"
      ],
      "answer": "In a flex layout with wrapping"
    }
]
